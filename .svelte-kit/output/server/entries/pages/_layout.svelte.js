...
function Navbar($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<nav${attr_class("navbar svelte-rfuq4y", void 0, {
			"scrolled": scrolled,
			"menu-open": menuOpen
		})}><div class="nav-inner svelte-rfuq4y"><a${attr("href", `${base}/`)} class="logo svelte-rfuq4y"><span class="logo-bracket svelte-rfuq4y">[</span> <span class="logo-text svelte-rfuq4y">PORTFOLIO</span> <span class="logo-bracket svelte-rfuq4y">]</span> <span class="logo-cursor svelte-rfuq4y">_</span></a> <ul class="nav-links svelte-rfuq4y"><!--[-->`);
...
function Footer($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<footer class="footer svelte-jz8lnl"><div class="footer-glow svelte-jz8lnl"></div> <div class="footer-inner svelte-jz8lnl"><div class="footer-grid svelte-jz8lnl"><div class="footer-brand svelte-jz8lnl"><div class="footer-logo svelte-jz8lnl"><span class="logo-bracket svelte-jz8lnl">[</span> <span class="svelte-jz8lnl">PORTFOLIO</span> <span class="logo-bracket svelte-jz8lnl">]</span></div> <p class="footer-desc svelte-jz8lnl">Un percorso di crescita, curiosità e passione per la tecnologia. Dalla terza superiore alla maturità.</p></div> <div class="footer-nav svelte-jz8lnl"><h4 class="footer-nav-title svelte-jz8lnl">Sezioni</h4> <ul class="svelte-jz8lnl"><li class="svelte-jz8lnl"><a${attr("href", `${base}/`)} class="svelte-jz8lnl">Home</a></li> <li class="svelte-jz8lnl"><a${attr("href", `${base}/educazione-civica`)} class="svelte-jz8lnl">Ed. Civica</a></li></ul></div> <div class="footer-contact svelte-jz8lnl"><h4 class="footer-nav-title svelte-jz8lnl">Contatti</h4> <p class="footer-email svelte-jz8lnl">lorenzo.andruetto@istitutoagnelli.it</p> <div class="socials svelte-jz8lnl"><!--[-->`);
